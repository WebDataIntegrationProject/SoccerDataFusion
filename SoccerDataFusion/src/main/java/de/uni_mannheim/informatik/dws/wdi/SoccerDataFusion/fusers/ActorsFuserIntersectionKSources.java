...
public class ActorsFuserIntersectionKSources extends
		AttributeValueFuser<List<Player>, Club, Attribute> {
	...
	public ActorsFuserIntersectionKSources(int k) {
		super(new IntersectionKSources<Player, Club, Attribute>(k));
	}
	...
	public void fuse(RecordGroup<Club, Attribute> group, Club fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord
				.setAttributeProvenance(Club.ACTORS, fused.getOriginalIds());
	}
