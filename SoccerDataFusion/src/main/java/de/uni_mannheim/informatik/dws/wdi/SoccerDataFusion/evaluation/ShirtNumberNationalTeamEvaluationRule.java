 ...
 * 
 */
public class ShirtNumberNationalTeamEvaluationRule extends EvaluationRule<Player, Attribute> {

	@Override
	public boolean isEqual(Player record1, Player record2, Attribute schemaElement) {
		if(record1.getShirtNumberOfNationalTeam()== null && record2.getShirtNumberOfNationalTeam()==null)
			return true;
		else if(record1.getShirtNumberOfNationalTeam()== null ^ record2.getShirtNumberOfNationalTeam()==null)
			return false;
		else 
			return record1.getShirtNumberOfNationalTeam().equals(record2.getShirtNumberOfNationalTeam());
	}
