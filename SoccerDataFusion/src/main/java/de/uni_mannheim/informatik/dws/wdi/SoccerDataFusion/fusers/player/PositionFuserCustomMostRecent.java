...
import de.uni_mannheim.informatik.dws.wdi.SoccerDataFusion.fusers.player.conflictresolution.PositionMostRecent;
 ...
 * 
 */
public class PositionFuserCustomMostRecent extends AttributeValueFuser<String, Player, Attribute> {
	
	
	public PositionFuserCustomMostRecent() {
		super(new PositionMostRecent<String, Player, Attribute>());
	}
