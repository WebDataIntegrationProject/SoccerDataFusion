...
/**
 * {@link EvaluationRule} for the heights of {@link Player}s. The rule simply
 * compares the height of two {@link Player}s and returns true, in case they
 * are identical.
 * 
 * 
 */
public class HeightEvaluationRule extends EvaluationRule<Player, Attribute> {
	...
	public boolean isEqual(Player record1, Player record2, Attribute schemaElement) {
		if(record1.getHeight()== null && record2.getHeight()==null)
			...
			return false;
		else if ((record1.getHeight() - record2.getHeight()) > record1.getHeight() * threshold)  
			return false;
		else 
			return true;
	}
