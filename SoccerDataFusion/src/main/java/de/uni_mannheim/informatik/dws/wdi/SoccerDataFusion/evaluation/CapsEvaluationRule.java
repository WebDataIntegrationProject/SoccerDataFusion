 ...
 * 
 */
public class CapsEvaluationRule extends EvaluationRule<Player, Attribute> {

	@Override
	public boolean isEqual(Player record1, Player record2, Attribute schemaElement) {
		if(record1.getCaps()== null && record2.getCaps()==null)
			return true;
		else if(record1.getCaps()== null ^ record2.getCaps()==null)
			return false;
		else 
			return record1.getCaps() == record2.getCaps();
	}
