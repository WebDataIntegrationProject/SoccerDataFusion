 ...
 * 
 */
public class ShirtNumberOfClubEvaluationRule extends EvaluationRule<Player, Attribute> {

	@Override
	public boolean isEqual(Player record1, Player record2, Attribute schemaElement) {
		if(record1.getShirtNumberOfClub()== null && record2.getShirtNumberOfClub()==null)
			return true;
		else if(record1.getShirtNumberOfClub()== null ^ record2.getShirtNumberOfClub()==null)
			return false;
		else 
			return record1.getShirtNumberOfClub().equals(record2.getShirtNumberOfClub());
	}
