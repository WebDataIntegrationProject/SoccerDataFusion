...
/**
 * {@link EvaluationRule} for the titles of {@link Club}s. The rule simply
 * compares the titles of two {@link Club}s and returns true, in case their
 * similarity based on {@link TokenizingJaccardSimilarity} is 1.0.
 * 
 * @author Oliver Lehmberg (oli@dwslab.de)
 * 
 */
public class TitleEvaluationRule extends EvaluationRule<Club, Attribute> {
