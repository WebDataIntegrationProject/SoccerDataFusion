...
/**
 * {@link AttributeValueFuser} for the city of stadium of {@link Club}s. 
 * 
 * @author Oliver Lehmberg (oli@dwslab.de)
 * 
 */
public class CityOfStadiumFuserVoting extends AttributeValueFuser<String, Club, Attribute> {

	public CityOfStadiumFuserVoting() {
	...
	public void fuse(RecordGroup<Club, Attribute> group, Club fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setCityOfStadium(fused.getValue());
		fusedRecord.setAttributeProvenance(Club.CITYOFSTADIUM, fused.getOriginalIds());
	}
