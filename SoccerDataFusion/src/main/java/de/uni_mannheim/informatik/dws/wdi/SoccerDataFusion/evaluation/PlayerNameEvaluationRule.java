...
/**
 * {@link EvaluationRule} for the names of {@link Club}s. The rule simply
 * compares the names of two {@link Club}s and returns true, in case their
 * similarity based on {@link TokenizingJaccardSimilarity} is 1.0.
 * 
 * @author Oliver Lehmberg (oli@dwslab.de)
 * 
 */
public class PlayerNameEvaluationRule extends EvaluationRule<Player, Attribute> {
	...
	public boolean isEqual(Player record1, Player record2, Attribute schemaElement) {
		...
		// matter
		return sim.calculate(record1.getFullName(), record2.getFullName()) == 1.0;
	}
