...
/**
 * {@link AttributeValueFuser} for the birthplace of {@link Players}s. 
 * 
 * 
 */
public class BirthplaceFuserVoting extends AttributeValueFuser<String, Player, Attribute> {

	public BirthplaceFuserVoting() {
