...
import de.uni_mannheim.informatik.dws.wdi.SoccerDataFusion.fusers.player.conflictresolution.FullNameSpecialCharacters;
 ...
 * 
 */
public class PlayerNameFuserSpecialChar extends AttributeValueFuser<String, Player, Attribute> {
	
	
	public PlayerNameFuserSpecialChar() {
		super(new FullNameSpecialCharacters<String, Player, Attribute>());
	}
	...
	public void fuse(RecordGroup<Player, Attribute> group, Player fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setAttributeProvenance(Player.FULLNAME, fused.getOriginalIds());
	}
