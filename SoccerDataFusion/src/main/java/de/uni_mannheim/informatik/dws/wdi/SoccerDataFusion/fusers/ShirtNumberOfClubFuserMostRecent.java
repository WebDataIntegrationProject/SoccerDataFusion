...
/**
 * {@link AttributeValueFuser} for the shirt number of club of {@link Player}s.
 * 
 * 
 */
public class ShirtNumberOfClubFuserMostRecent extends
		AttributeValueFuser<String, Player, Attribute> {

	public ShirtNumberOfClubFuserMostRecent() {
	...
	public void fuse(RecordGroup<Player, Attribute> group, Player fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord
				.setAttributeProvenance(Player.SHIRTNUMBEROFCLUB, fused.getOriginalIds());
	}
