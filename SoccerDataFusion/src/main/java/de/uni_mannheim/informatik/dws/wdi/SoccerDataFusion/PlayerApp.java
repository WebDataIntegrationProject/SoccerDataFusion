...
public class PlayerApp 
{
    public static void main( String[] args ) throws Exception
    {
		...
		strategy.addAttributeFuser(Player.FULLNAME, new PlayerNameFuserLongestString(),new NameEvaluationRule());
		strategy.addAttributeFuser(Player.BIRTHPLACE,new CountryFuserLongestString(), new CountryEvaluationRule());
		strategy.addAttributeFuser(Player.BIRTHDATE, new NameOfStadiumFuserLongestString(),new NameOfStadiumEvaluationRule());
		strategy.addAttributeFuser(Player.NATIONALITY,new CityOfStadiumFuserVoting(),new CityOfStadiumEvaluationRule());
		strategy.addAttributeFuser(Player.HEIGHT,new LeagueFuserMostRecent(),new LeagueEvaluationRule());
		strategy.addAttributeFuser(Player.WEIGHT,new PlayersFuserUnion(),new PlayersEvaluationRule());
		strategy.addAttributeFuser(Player.SHIRTNUMBEROFCLUB,new PlayersFuserUnion(),new PlayersEvaluationRule());
		strategy.addAttributeFuser(Player.SHIRTNUMBEROFNATIONALTEAM,new PlayersFuserUnion(),new PlayersEvaluationRule());
		strategy.addAttributeFuser(Player.POSITION,new PlayersFuserUnion(),new PlayersEvaluationRule());
		strategy.addAttributeFuser(Player.PREFERREDFOOT,new PlayersFuserUnion(),new PlayersEvaluationRule());
		strategy.addAttributeFuser(Player.CAPS,new PlayersFuserUnion(),new PlayersEvaluationRule());
		strategy.addAttributeFuser(Player.ISINNATIONALTEAM,new PlayersFuserUnion(),new PlayersEvaluationRule());
		strategy.addAttributeFuser(Player.CLUBMEMBERSHIPVALIDASOF,new PlayersFuserUnion(),new PlayersEvaluationRule());
		strategy.addAttributeFuser(Player.CLUBNAME,new PlayersFuserUnion(),new PlayersEvaluationRule());
