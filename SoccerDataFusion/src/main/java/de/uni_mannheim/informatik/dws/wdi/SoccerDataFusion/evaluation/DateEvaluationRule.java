...
/**
 * {@link EvaluationRule} for the date of {@link Club}s. The rule simply
 * compares the year of the dates of two {@link Club}s.
 * 
 * @author Oliver Lehmberg (oli@dwslab.de)
 * 
 */
public class DateEvaluationRule extends EvaluationRule<Club, Attribute> {
