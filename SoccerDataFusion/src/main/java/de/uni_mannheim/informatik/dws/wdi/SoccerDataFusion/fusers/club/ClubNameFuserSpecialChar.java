...
import de.uni_mannheim.informatik.dws.wdi.SoccerDataFusion.fusers.club.conflictresolution.NameSpecialCharacters;
 ...
 * 
 */
public class ClubNameFuserSpecialChar extends
		AttributeValueFuser<String, Club, Attribute> {

	public ClubNameFuserSpecialChar() {
		super(new NameSpecialCharacters<String, Club, Attribute>());
	}
	...
	public void fuse(RecordGroup<Club, Attribute> group, Club fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setAttributeProvenance(Club.NAME,
